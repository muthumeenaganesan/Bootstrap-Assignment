/*
	FORD PROD
	140815 - two new standalone variables v16
	141029 - add AAM function
	141031 - no change, made LN change
	7/17/2015 - updated to v57, added auto-created "target-global-mbox", added targetPageParams to pass "zip" param
*/
...
TNT.a.b = {
 ...
 "imsOrgId": "EFD95E09512D2A8E0A490D4D@AdobeOrg",
...
/******************************* SPECIAL CASE EVARS ******************************/
var fv_v16 = cookieRead('fv_v16')
if(fv_v16 != 'noCookie'){
	try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_v16",fv_v16);
	 }catch(e){/*do nothing*/}
}

var fv_v54 = cookieRead('fv_v54')
if(fv_v54 != 'noCookie'){
	try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_v54",fv_v54);
	 }catch(e){/*do nothing*/}
}

/************************************** EVARS ************************************/
var fv_v1_v10 = cookieRead('fv_v1_v10')
if(fv_v1_v10 != 'noCookie'){
	try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_v1_v10",fv_v1_v10);
	 }catch(e){/*do nothing*/}
}

var fv_v11_v20 = cookieRead('fv_v11_v20')
if(fv_v11_v20 != 'noCookie'){
	 try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_v11_v20", fv_v11_v20);
	 }catch(e){/*do nothing*/}
}

var fv_v21_v30 = cookieRead('fv_v21_v30')
if(fv_v21_v30 != 'noCookie'){
	 try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_v21_v30", fv_v21_v30);
	 }catch(e){/*do nothing*/}
}

var fv_v31_v40 = cookieRead('fv_v31_v40')
if(fv_v31_v40 != 'noCookie'){
	 try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_v31_v40", fv_v31_v40);
	 }catch(e){/*do nothing*/}
}

var fv_v41_v50 = cookieRead('fv_v41_v50')
if(fv_v41_v50 != 'noCookie'){
	 try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_v41_v50", fv_v41_v50);
	 }catch(e){/*do nothing*/}
}

var fv_v51_v60 = cookieRead('fv_v51_v60')
if(fv_v51_v60 != 'noCookie'){
	 try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_v51_v60", fv_v51_v60);
	 }catch(e){/*do nothing*/}
}

var fv_v61_v70 = cookieRead('fv_v61_v70')
if(fv_v61_v70 != 'noCookie'){
	 try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_v61_v70", fv_v61_v70);
	 }catch(e){/*do nothing*/}
}

/************************************** EVENTS ************************************/

var fv_ev1_ev10 = cookieRead('fv_ev1_ev10')
if(fv_ev1_ev10 != 'noCookie'){
	try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_ev1_ev10",fv_ev1_ev10);
	 }catch(e){/*do nothing*/}
}

var fv_ev11_ev20 = cookieRead('fv_ev11_ev20')
if(fv_ev11_ev20 != 'noCookie'){
	try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_ev11_ev20",fv_ev11_ev20);
	 }catch(e){/*do nothing*/}
}

/***************************** SPECIAL CASES ****************************/
var fv_entpg = cookieRead('fv_entpg')
if(fv_entpg != 'noCookie'){
	try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_entpg",fv_entpg);
	 }catch(e){/*do nothing*/}
}

var fv_refdom = cookieRead('fv_refdom')
if(fv_refdom != 'noCookie'){
	try{
		var tapMboxBuilder = mboxFactoryDefault.getUrlBuilder();
		tapMboxBuilder.addParameter("profile.fv_refdom",fv_refdom);
	 }catch(e){/*do nothing*/}
}

function targetPageParams(){
	if (getZipCodeForMbox && typeof(getZipCodeForMbox) === "function"){
		var zip=getZipCodeForMbox();
		return 'zip=' + zip;
	}
}
...
/*Note: AAM API call is separate from mbox.js*/